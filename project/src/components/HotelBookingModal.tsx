                            ...
                            <div className="flex gap-2">
                              {booking.booking_link && (
                                <button
                                  ...
                                  className="flex-1 sm:flex-none px-4 py-3 sm:px-3 sm:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-sm sm:text-xs font-medium flex items-center justify-center gap-1"
                                >
