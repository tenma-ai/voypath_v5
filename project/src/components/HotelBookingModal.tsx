...
const HotelBookingModal: React.FC<HotelBookingModalProps> = ({
  ...
  const handleAddToTrip = async (booking: HotelBooking) => {
    ...
    try {
      ...
      // Step 2: Add existing booking to trip (creates place constraints + triggers edit-schedule)
      console.log('🎯 Adding existing hotel booking to trip as time constraints...');
