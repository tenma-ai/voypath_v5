...
const TransportBookingModal: React.FC<TransportBookingModalProps> = ({
  ...
  const handleAddToTrip = async (booking: TransportBooking) => {
    ...
    try {
      ...
      // Step 2: Add existing booking to trip (creates endpoint constraints + triggers edit-schedule)
      console.log('🎯 Adding existing transport booking to trip as endpoint constraints...');
